...
export function UpdateFRAPage({
  ...
  const [endDate, setEndDate] = useState(formatDateTimeLocalInput(fra.endDate));
  ...
  // submitUpdatedFRA(...)
  async function submitUpdatedFRA(
    fra_id: string,
    title: string,
    description: string,
    category: string,
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    void submitUpdatedFRA(fra.fraId, title, description, categoryId, endDate, status);
  }

  // displayCurrentFRA()
  const displayCurrentFRA = () => (
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            min={
              fra.startDate
                ? formatDateTimeLocalInput(fra.startDate)
