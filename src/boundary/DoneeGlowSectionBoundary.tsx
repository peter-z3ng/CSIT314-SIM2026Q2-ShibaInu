...
export function DoneeGlowSectionBoundary({ totalDonated }: { totalDonated: number }) {
  ...
  return (
    <div
      className="relative left-1/2 z-10 -mt-35 h-[22vw] w-[40vw] -translate-x-1/2 rounded-t-full transition-[background,box-shadow] duration-500"
      style={{
    ...
    >
      <div className="absolute left-1/2 top-[42%] -translate-x-1/2 text-center">
        ...
        <p className="mt-2 text-5xl font-black text-[#1d2520]">${totalDonated.toFixed(2)}</p>
